  ...
  <div id="div-signup" class="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs">
    <div class="p-4 sm:p-7">
      <div class="text-center">
        <h1 class="block text-2xl font-bold text-gray-800">S'inscrire</h1>
        <p class="mt-2 text-sm text-gray-600">
          Vous avez déjà un compte ?
          <a class="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" href="./signin.php">
            Connectez-vous ici
          </a>
        </p>
      </div>
          ...
          <div class="grid gap-y-4">
            ...
            <div>
              <div class="flex gap-x-2">
                ...
                <label for="prenom" class="block text-sm mb-2 text-red-900">*</label>
              </div>
              <div class="relative">
                <input type="text" id="prenom" name="prenom" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="email-error">
            ...
            <div>
              <div class="flex gap-x-2">
                ...
                <label for="nom" class="block text-sm mb-2 text-red-900">*</label>
              </div>
              <div class="relative">
                <input type="text" id="nom" name="nom" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="email-error">
                <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                  <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                  </svg>
            ...
            <div>
              <div class="flex gap-x-2">
                <label for="email" class="block text-sm mb-2">Adresse mail</label>
                <label for="email" class="block text-sm mb-2 text-red-900">*</label>
              </div>
              <div class="relative">
            ...
            <!-- End Form Group -->
             <!-- Form Group -->
            <div>
              <label for="tel" class="block text-sm mb-2">Téléphone</label>
              <div class="relative">
                <input type="text" id="tel" name="tel" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" aria-describedby="email-error">
                <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                  <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                  </svg>
            ...
            <div>
              <div class="flex gap-x-2">
                ...
                <label for="password" class="block text-sm mb-2 text-red-900">*</label>
              </div>
              <div class="relative">
            ...
            <div>
              <div class="flex gap-x-2">
                <label for="confirm-password" class="block text-sm mb-2">Confirmez le mot de passe</label>
                <label for="confirm-password" class="block text-sm mb-2 text-red-900">*</label>
              </div>
              <div class="relative">
                <input type="password" id="confirm-password" name="confirm-password" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="confirm-password-error">
                <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                  <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                  </svg>
