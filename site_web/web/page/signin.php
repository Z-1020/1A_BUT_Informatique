  ...
  <div id="div-signin" class="mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs">
    <div class="p-4 sm:p-7">
      ...
      <div class="mt-5">
        ...
        <!-- Form -->
        <form action="../session/connectAccount.php" method="POST">
          <div class="grid gap-y-4">
            ...
            <div>
              <div class="flex flex-wrap justify-between items-center gap-2">
                ...
                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="../examples/html/recover-account.html">
                  Mot de passe oublié ?
              </a>
              </div>
              <div class="relative">
